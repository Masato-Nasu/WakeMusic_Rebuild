...
public final class ItemAlarmBinding implements ViewBinding {
  ...
  private ItemAlarmBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnDelete,
      @NonNull SwitchMaterial swEnabled, @NonNull TextView tvTime) {
  ...
  public static ItemAlarmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAlarmBinding((LinearLayout) rootView, btnDelete, swEnabled, tvTime);
    }
